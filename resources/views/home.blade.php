<x-layout>
    ...
    <section class="container mt-8">
        <div id="indicators-carousel" class="relative w-full" data-carousel="static">
            <!-- Carousel wrapper -->
            <div class="relative h-56 overflow-hidden rounded-base md:h-96 shadow-md/20">
                <!-- Item 1 -->
    ...
    <section class="mt-8">
        <div class="container">
            <h2 class="text-lg z-10">Featured Brands</h2>
            <div class="scroll-container-slider">
                <div class="container-slider">
                    <div class="card" onclick="navigateToPage('page1.html')">
                        <h3>Card 1</h3>
                        <p class="description">Short description for card 1.</p>
                    </div>
                    <div class="card" onclick="navigateToPage('page2.html')">
                        <h3>Card 2</h3>
                        <p class="description">Short description for card 2.</p>
                    </div>
                    <div class="card" onclick="navigateToPage('page3.html')">
                        <h3>Card 3</h3>
                        <p class="description">Short description for card 3.</p>
                    </div>
                    <div class="card" onclick="navigateToPage('page3.html')">
                        <h3>Card 4</h3>
                        <p class="description">Short description for card 3.</p>
    ...
    <section>
        <div class="container">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 featured__filter">
